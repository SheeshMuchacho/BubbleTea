                            ...
                            @endif
                                ...
                                <form action="{{ url('userupdate', $user->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" style="margin: 40px 0;">
                                        ...
                                        <input type="password" style="background-color: #2A3038" name="password" class="form-control">
                                    </div>

                                    <div class="form-group" style="margin: 40px 0;">
                                        <label for="password_confirmation">Confirm Password</label>
                                        <input type="password" style="background-color: #2A3038" name="password_confirmation" class="form-control">
                                    </div>
