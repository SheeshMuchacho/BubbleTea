                                ...
                                @endif
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($admins as $admin)
                                            ...
                                            <td style="text-align: center"><a class="btn btn-inverse-primary" href="">Update</a></td>
                                            <td style="text-align: center"><a class="btn btn-inverse-danger" href="{{url('admindelete', $admin->id)}}">Delete</a></td>
                                            </tbody>
                                        @endforeach
                                    </table>
